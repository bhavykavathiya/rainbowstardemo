...
const LoginGate = ({ children }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-20 text-center" data-testid="login-gate">
      <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#FFF8E1] border border-[#b8960c]/40 mb-6">
        <Lock size={26} className="text-[#8a7009]"/>
      </div>
      ...
      <div className="mt-12 flex justify-center gap-2 opacity-60">
        <Diamond size={14} className="text-[#b8960c]"/>
