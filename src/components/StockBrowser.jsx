...
import { CATEGORY_META, fetchDiamonds } from '../lib/api';
import FilterPanel from '../components/FilterPanel';
import { StoneCard, StoneRow } from '../components/Stone';
import { Grid3x2 as Grid3X3, Rows2 as Rows, Search, Loader as Loader2 } from 'lucide-react';
...
const StockBrowser = ({ category, categories, accent, title, subtitle, headerBg, extra, argyleClass, certLabs }) => {
  ...
  useEffect(() => {
    ...
    fetchDiamonds(params).then(data => setStones(data)).finally(() => setLoading(false));
