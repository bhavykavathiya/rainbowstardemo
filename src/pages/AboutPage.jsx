...
import { Diamond, Award, Globe, ShieldCheck, Sparkles, Cog, Users, Handshake, TrendingUp, CircleCheck as CheckCircle2, ArrowRight, Quote } from 'lucide-react';
...
const BUSINESSES = [
  { t: 'Natural Fancy Color Diamonds', d: 'Earth-mined fancy colors — pinks, blues, yellows, greens — with full GIA grading.', a: '#b8960c' },
  { t: 'Natural White Diamonds', d: 'Colorless D-J range, brilliant precision-cut, all major lab certificates.', a: '#d4af37' },
  { t: 'CVD Lab-Grown Diamonds', d: 'Type IIa lab-grown stones with IGI/GIA reports — identical brilliance, modern value.', a: '#b8960c' },
  ...
  return (
    <div data-testid="about-page">
      ...
      <section className="relative overflow-hidden border-b border-[#E8DFC2]">
        ...
        <div className="absolute top-0 left-1/3 w-[500px] h-[500px] bg-[#b8960c]/8 rounded-full blur-[150px]"/>
        <div className="relative max-w-7xl mx-auto px-6 py-24">
          <div className="overline mb-4 text-[#b8960c]">About Rainbow Star</div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="space-y-5 text-[#1A1505] leading-relaxed text-[15px]">
          <p>Since <span className="text-[#b8960c]">2009</span>, Rainbow Star has been actively serving the diamond industry with a commitment to quality, integrity, and long-term relationships.</p>
          <p>Based in <span className="text-[#b8960c]">Surat, Gujarat</span> — the world's leading diamond manufacturing hub — we have established ourselves as a reliable partner in Natural Fancy Color Diamonds, Natural White Diamonds, CVD Lab-Grown Diamonds, and CVD Diamond Manufacturing Services.</p>
          <p>Over the years, our company has developed extensive expertise across sourcing, manufacturing, processing, and supplying diamonds to clients across global markets. Whether serving jewelers, wholesalers, manufacturers, retailers, or investors, our focus remains the same: <span className="text-[#d4af37]">delivering exceptional value, consistent quality, and dependable service.</span></p>
      ...
      <section className="border-y border-[#E8DFC2] bg-[#FAF6E8]/50 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="overline mb-3 text-[#b8960c]">Core Businesses</div>
          <h2 className="font-serif text-4xl md:text-5xl mb-12">Four pillars of expertise</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {BUSINESSES.map((b, i) => (
              <motion.div key={i} initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{delay: i*0.1}} className="bg-white border border-[#D9CB94] p-6 hover:border-[#b8960c]/40 transition">
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        <div className="overline mb-3 text-[#b8960c] text-center">Message From The Chairman</div>
        ...
        <div className="grid md:grid-cols-5 gap-10 items-start">
          ...
          <div className="md:col-span-3 relative">
            <Quote size={48} className="text-[#b8960c]/20 absolute -top-4 -left-2"/>
            <div className="space-y-5 text-[#1A1505] leading-relaxed text-[15px] relative pl-6 border-l border-[#D9CB94]">
              ...
              <div className="pt-2">
                <div className="font-serif text-2xl text-[#d4af37]">— Jayesh Kavathiya</div>
      ...
      <section className="border-y border-[#E8DFC2] bg-[#FAF6E8]/50 py-20">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          <div>
            <div className="overline mb-3 text-[#b8960c]">Our Vision</div>
          ...
          <div>
            <div className="overline mb-3 text-[#b8960c]">Our Mission</div>
            <h3 className="font-serif text-3xl md:text-4xl mb-5">Six commitments that guide us.</h3>
            <ul className="space-y-3">
              {MISSION.map((m, i) => (
                <li key={i} className="flex gap-3 text-[#1A1505] text-sm leading-relaxed"><CheckCircle2 size={18} className="text-[#b8960c] shrink-0 mt-0.5"/>{m}</li>
              ))}
            </ul>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="overline mb-3 text-[#b8960c]">Why Choose Rainbow Star</div>
        <h2 className="font-serif text-4xl md:text-5xl mb-12">Nine reasons trade partners trust us.</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {WHY.map((w, i) => (
            <motion.div key={i} initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{delay: i*0.08}} className="bg-white border border-[#E8DFC2] p-6 hover:border-[#b8960c]/35 transition">
              <w.icon size={22} className="text-[#b8960c] mb-3"/>
